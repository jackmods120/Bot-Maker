...
KB_CHAN = ReplyKeyboardMarkup([
    ...
    [KeyboardButton("✅ چالاککردنی داواکردنی کانال"),KeyboardButton("❌ لەکارخستنی داواکردن")],
...
@app.get("/api/main")
async def health():
    return {"status":"active","version":BOT_VERSION,"keep_alive":"✅"}
